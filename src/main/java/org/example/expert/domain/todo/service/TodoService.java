...
public class TodoService {
    ...
    public Page<TodoResponse> getTodos(int page, int size, LocalDate startDate, LocalDate endDate, String weather) {
        ...
        Page<Todo> todos = todoRepository.findAllByOptions(pageable, weather, startDateTime, endDateTime);
    ...
    public Page<TodoSearchResponse> searchTodo(int page, int size, String title, LocalDate startDate, LocalDate endDate, String nickname){
        ...
        return todoRepository.searchTodo(pageable, title, startDateTime, endDateTime, nickname);
    }
}
